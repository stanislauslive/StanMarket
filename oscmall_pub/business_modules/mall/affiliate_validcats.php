...
<body marginwidth="10" marginheight="10" topmargin="10" bottommargin="10" leftmargin="10" rightmargin="10">
	...
	<table width="580" class="infoBoxContents1">
<tr>
<td colspan="2" class="infoBoxHeading1" align="center"><?php echo TEXT_VALID_CATEGORIES_LIST; ?></td>
</tr>
<?
    ...
    if ($row = mysql_fetch_array($result)) {
        do {
            echo "<td class='infoBoxContents1'>&nbsp".$row["categories_id"]."</td>\n";
            echo "<td class='infoBoxContents1'>".$row["categories_name"]."</td>\n";
            echo "</tr>\n";
        }
