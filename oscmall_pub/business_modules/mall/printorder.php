...
<table width="600" border="0" align="center" cellpadding="2" cellspacing="0">
      ...
      <tr> 
        <td><table border="0" align="center" width="75%" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td class="pageHeading" align="right"><?php echo tep_image(DIR_WS_IMAGES . $store->get_store_logo(), $store->get_store_name()); ?></td>
          </tr>
          <tr> 
  ...
  <tr>
    ...
    <tr>
       <td class="main"><b><?php echo ENTRY_ORDER_DATE; ?></b><?php echo tep_date_long($order->info['date_purchased']); ?></td>
           </tr>
      <tr> 
...
<?php
  ...
  while ($statuses = tep_db_fetch_array($statuses_query)) {
    echo '              <tr>' . "\n" .
         '                <td class="main" valign="top" width="100">' . tep_date_short($statuses['date_added']) . '</td>' . "\n" .
