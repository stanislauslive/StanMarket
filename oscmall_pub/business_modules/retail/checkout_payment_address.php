...
/*Added store id in the link FILENAME_CHECKOUT_PAYMENT by Cimi on June 12,2007*/
...
/*Added store id in the link FILENAME_CHECKOUT_PAYMENT and  FILENAME_CHECKOUT_PAYMENT_ADDRESS by Cimi on June 12,2007*/
  $breadcrumb->add(NAVBAR_TITLE_1, smn_href_link(FILENAME_CHECKOUT_PAYMENT, 'ID='.$_REQUEST['ID'], 'NONSSL'));
  $breadcrumb->add(NAVBAR_TITLE_2, smn_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, 'ID='.$_REQUEST['ID'], 'NONSSL'));
