...
// a shipping address is not needed
  if ($order->content_type == 'virtual') {
    ...
    $sendto = false;
/*Added the store id in the links FILENAME_CHECKOUT_PAYMENT  by Cimi on June 12,2007*/
...
/*Added the store id in the links FILENAME_CHECKOUT_SHIPPING  by Cimi on June 12,2007*/
        smn_redirect(smn_href_link(FILENAME_CHECKOUT_SHIPPING, 'ID='.$_REQUEST['ID'], 'NONSSL'));
      }
...
/*Added the store id in the links FILENAME_CHECKOUT_SHIPPING and FILENAME_CHECKOUT_SHIPPING_ADDRESS by Cimi on June 12,2007*/
  $breadcrumb->add(NAVBAR_TITLE_1, smn_href_link(FILENAME_CHECKOUT_SHIPPING, 'ID='.$_REQUEST['ID'], 'NONSSL'));
  $breadcrumb->add(NAVBAR_TITLE_2, smn_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, 'ID='.$_REQUEST['ID'], 'NONSSL'));
