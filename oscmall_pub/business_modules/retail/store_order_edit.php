...
// include the mail classes
  ...
  $breadcrumb->add(NAVBAR_TITLE_2, smn_href_link(FILENAME_STORE_ORDER_TOOL, 'ID='.$store_id, 'NONSSL'));
  $breadcrumb->add(NAVBAR_TITLE_3, smn_href_link(FILENAME_STORE_ORDER_EDIT, 'oID='.$oID.'&action=edit&ID='.$store_id, 'NONSSL'));
?>