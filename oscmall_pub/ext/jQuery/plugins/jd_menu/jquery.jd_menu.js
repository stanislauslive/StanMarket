...
(function($){
	function addEvents(ul) {
		...
		$('> li', ul).bind('mouseenter.jdmenu mouseleave.jdmenu', function(evt) {
		    ...
		    if ($(this).attr('ajaxlink') == 'true'){
		        $(this).bind('ajaxClick', function (e){
		            var $link = $(this);
		            ...
		            $('#contentColumnDiv').empty().append(loadingDiv);
		            jQuery.ajax({
		                url: this.href,
		                type: 'get',
                        cache: false,
                        ...
                        success: function (html){
                            if (html[0] == '{'){
                                eval('var text = ' + html + '');
                                $.ajax_unsuccessful_message_box(text);
                            }else{
                                $('#contentColumnDiv').empty().append(html);
                            }
                        }
		            });
		        }).click(function (e){
