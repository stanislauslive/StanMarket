...
?>
     ...
     <?php echo smn_draw_form('account_newsletter', smn_href_link(FILENAME_ACCOUNT_NEWSLETTERS, '', 'NONSSL')) . smn_draw_hidden_field('action', 'process'); ?>
              ...
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr class="moduleRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="checkBox('newsletter_general')">
                    <td class="main"><?php echo smn_draw_checkbox_field('newsletter_general', '1', (($newsletter['customers_newsletter'] == '1') ? true : false), 'onclick="checkBox(\'newsletter_general\')"'); ?></td>
