...
*/
?>
    <?php if (!isset($_GET['delete'])) echo smn_draw_form('addressbook', smn_href_link(FILENAME_ADDRESS_BOOK_PROCESS, (isset($_GET['edit']) ? 'edit=' . $_GET['edit'] : ''), 'NONSSL'), 'post', 'onSubmit="return check_form(addressbook);"'); ?>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><?php echo '<a href="' . smn_href_link(FILENAME_ADDRESS_BOOK, '', 'NONSSL') . '">' . smn_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
                <td align="right"><?php echo '<a href="' . smn_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'delete=' . $_GET['delete'] . '&action=deleteconfirm', 'NONSSL') . '">' . smn_image_button('button_delete.gif', IMAGE_BUTTON_DELETE) . '</a>'; ?></td>
                <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
            </table></td>
          </tr>
...
<?php
      ...
      if (sizeof($navigation->snapshot) > 0) {
        ...
        $back_link = smn_href_link(FILENAME_ADDRESS_BOOK, '', 'NONSSL');
      }
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
