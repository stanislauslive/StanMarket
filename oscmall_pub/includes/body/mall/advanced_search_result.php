...
// create column list
  ...
  $from_str = "from " . TABLE_PRODUCTS . " p left join " . TABLE_MANUFACTURERS . " m using(manufacturers_id), " . TABLE_PRODUCTS_DESCRIPTION . " pd,  " . TABLE_CATEGORIES . " c, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c left join " . TABLE_SPECIALS . " s using(products_id)";
...
/*	$select_str = "select p.*, pd.* ";
	...
	$where_str = " where p.products_id = pd.products_id ";
*/
...
*/  
  ...
  if (isset($_POST['keywords']) && !empty($_POST['keywords'])) {
  	//$search_keywords[] = $_POST['product_description'];
	$where_str .= " and (pd.products_name like '%" . $_POST['keywords'] . "%' or pd.products_description like '%" . $_POST['keywords'] . "%')";
  }
...
*/
 ...
 // echo $listing_sql;
  ...
  if (USE_JAVASCRIPT_LIBRARY == 'true'){
     require(DIR_WS_MODULES . 'product_listing_js.php');
  }else{
