...
*/
 ?>
    ...
    <?php echo smn_draw_form('checkout_address', smn_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'NONSSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"'); ?>
