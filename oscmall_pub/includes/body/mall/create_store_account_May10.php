        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td align="left"><table border="0" cellspacing="0" cellpadding="0" align="left">
              <tr align="left">
                <td class="main" align="left"><?php echo  smn_draw_pull_down_menu('store_catagory', $spath_setup->smn_get_store_category_tree('0','', '0'), '', '');?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td>
              <tr>
                <td class="main"><?php echo smn_draw_textarea_field('store_description', 'soft', '50', '15');?></td>
              </tr>
            </td>
          </tr>
        </table></td>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
                ...
                <td class="main"><?php echo smn_draw_input_field('storename') . '&nbsp;' . (smn_not_null(ENTRY_STORE_NAME_TEXT) ? '<span class="inputRequirement">' . ENTRY_STORE_NAME_TEXT . '</span>': ''); ?></td>
                <td class="main"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="main"><?php echo smn_draw_input_field('email_address') . '&nbsp;' . (smn_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?></td>
                <td class="main">&nbsp;</td>
              </tr>
            </table></td>
          </tr>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo smn_draw_input_field('company') . '&nbsp;' . (smn_not_null(ENTRY_COMPANY_TEXT) ? '<span class="inputRequirement">' . ENTRY_COMPANY_TEXT . '</span>': NOT_REQUIRED_TEXT); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
