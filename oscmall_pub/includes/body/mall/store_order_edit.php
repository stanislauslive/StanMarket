      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="pageHeading" align="right"><?php echo '<a href="' . smn_href_link(FILENAME_STORE_ORDER_TOOL) . '">' . smn_image_button('button_back.gif', IMAGE_BACK) . '</a>'; ?></td>
          </tr>
        </table></td>
      </tr>
<?php
...
?>
      ...
      <tr><?php echo smn_draw_form('status', smn_href_link(FILENAME_STORE_ORDER_EDIT,  smn_get_all_get_params(array('action')) . 'action=update_order','NONSSL'),'POST'); ?>
...
?>
	...
	<tr class="infoBoxContents"><?php echo smn_draw_form('order_delete', smn_href_link(FILENAME_STORE_ORDER_EDIT,  smn_get_all_get_params(array('action')) . 'action=deleteconfirm','NONSSL'),'POST'); ?>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><?php echo '<a href="' . smn_href_link(FILENAME_STORE_ORDER_TOOL, '', 'NONSSL') . '">' . smn_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
