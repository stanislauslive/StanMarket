          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main"><?php echo  smn_image(DIR_WS_IMAGES . 'arrow_green.gif');if($affiliate_id){echo ' <a href="' . smn_href_link(FILENAME_AFFILIATE_ACCOUNT, '', 'NONSSL'). '">' . MY_ACCOUNT_INFORMATION . '</a>';}else{echo ' <a href="' . smn_href_link(FILENAME_ACCOUNT_EDIT, 'ID='.$store_id, 'NONSSL') . '">' . MY_ACCOUNT_INFORMATION . '</a>';} ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo smn_image(DIR_WS_IMAGES . 'arrow_green.gif') . ' <a href="' . smn_href_link(FILENAME_ADDRESS_BOOK, 'ID='.$store_id, 'NONSSL') . '">' . MY_ACCOUNT_ADDRESS_BOOK . '</a>'; ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo smn_image(DIR_WS_IMAGES . 'arrow_green.gif') . ' <a href="' . smn_href_link(FILENAME_ACCOUNT_PASSWORD, 'ID='.$store_id, 'NONSSL') . '">' . MY_ACCOUNT_PASSWORD . '</a>'; ?></td>
                  </tr>
<?php if($customer_store_id){ ?>
                  <tr>
                    <td class="main"><?php echo  smn_image(DIR_WS_IMAGES . 'arrow_green.gif');echo ' <a href="' . smn_href_link(FILENAME_STORE_PRODUCT_CATEGORIES, 'ID='.$store_id) . '">' . LOGIN_BOX_PRODUCT_TOOL . '</a>'; ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo  smn_image(DIR_WS_IMAGES . 'arrow_green.gif');echo ' <a href="' . smn_href_link(FILENAME_STORE_TEXT_EDITOR, 'ID='.$store_id) . '">' . LOGIN_BOX_STORE_TEXT_EDITOR . '</a>'; ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo  smn_image(DIR_WS_IMAGES . 'arrow_green.gif');echo ' <a href="' . smn_href_link(FILENAME_STORE_TAXES, 'ID='.$store_id) . '">Store\'s Taxes</a>'; ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo  smn_image(DIR_WS_IMAGES . 'arrow_green.gif');echo ' <a href="' . smn_href_link(FILENAME_STORE_MODULES, 'ID='.$store_id) . '">Store\'s Modules</a>'; ?></td>
                  </tr>
<?php } ?>
                </table></td>
        ...
        <td colspan="4"><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
			...
			<!--Changed the image path from images to images/affiliate_images,by Cimi -->                
                <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td width="60"><?php echo smn_image(DIR_WS_IMAGES . 'affiliate_links.gif'); ?></td>
                <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
...
<!--Changed the image path from images to images/affiliate_images,by Cimi -->
                <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td width="60"><?php echo smn_image(DIR_WS_IMAGES . 'affiliate_reports.gif'); ?></td>
                <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main"><?php echo smn_image(DIR_WS_IMAGES . 'arrow_green.gif') . ' <a href="' . smn_href_link(FILENAME_ACCOUNT_HISTORY, 'ID='.$store_id, 'NONSSL') . '">' . MY_ORDERS_VIEW . '</a>'; ?></td>
                  </tr>
				 <!-- Order Tool for store vendors Added By Cimi -->
				  <?php if($customer_store_id){ ?>
				  <tr>
                    <td class="main"><?php echo smn_image(DIR_WS_IMAGES . 'arrow_green.gif') . ' <a href="' . smn_href_link(FILENAME_STORE_ORDER_DETAILS, 'ID='.$store_id, 'NONSSL') . '">' . MY_ORDERS_FROM_ME_SINGLE_CHECKOUT . '</a>'; ?></td>
                  </tr>
				  <tr>
                    <td class="main"><?php echo smn_image(DIR_WS_IMAGES . 'arrow_green.gif') . ' <a href="' . smn_href_link(FILENAME_STORE_ORDER_TOOL, 'ID='.$store_id, 'NONSSL') . '">' . MY_ORDERS_TOOL . '</a>'; ?></td>
                  </tr>
				  <?php }?>
                </table></td>
                <td width="10" align="right"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main"><?php echo smn_image(DIR_WS_IMAGES . 'arrow_green.gif') . ' <a href="' . smn_href_link(FILENAME_ACCOUNT_NEWSLETTERS, 'ID='.$store_id, 'NONSSL') . '">' . EMAIL_NOTIFICATIONS_NEWSLETTERS . '</a>'; ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo smn_image(DIR_WS_IMAGES . 'arrow_green.gif') . ' <a href="' . smn_href_link(FILENAME_ACCOUNT_NOTIFICATIONS, 'ID='.$store_id, 'NONSSL') . '">' . EMAIL_NOTIFICATIONS_PRODUCTS . '</a>'; ?></td>
                  </tr>
                </table></td>
                <td width="10" align="right"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
