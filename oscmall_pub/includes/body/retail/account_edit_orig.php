...
?>
    ...
    <?php echo smn_draw_form('account_edit', smn_href_link(FILENAME_ACCOUNT_EDIT.'?ID='.$store_id, '', 'NONSSL'), 'post', 'onSubmit="return check_form(account_edit);" enctype="multipart/form-data"') . smn_draw_hidden_field('action', 'process'); ?>
              ...
              <tr class="infoBoxContents">
                ...
                <td><table border="0" cellspacing="2" cellpadding="2">
                  ...
                  <tr>
                    ...
                    <td class="main"><?php echo $account['customers_dob'];?><!--<?php echo substr($account['customers_dob'], 4, 2) . '-' . substr($account['customers_dob'], 6, 2) . '-' . substr($account['customers_dob'], 0, 4); ?>--></td>
...
<?php
        echo smn_draw_input_field('state', $account['entry_state']) . '&nbsp;' . (smn_not_null(ENTRY_STATE_TEXT) ? '<span class="inputRequirement">' . ENTRY_STATE_TEXT . '</span>': '');
		
		/*Deleted Sobin 08/05/2007 start
		$zones_array = array();
