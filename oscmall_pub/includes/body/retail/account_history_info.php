    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td class="smallText"><?php echo HEADING_ORDER_DATE . ' ' . smn_date_long($order->info['date_purchased']); ?></td>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><?php echo '<a href="' . smn_href_link(FILENAME_ACCOUNT_HISTORY, smn_get_all_get_params(array('order_id')), 'NONSSL') . '">' . smn_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
                <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
            </table></td>
          </tr>
