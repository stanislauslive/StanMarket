...
*/
?>
   <?php echo smn_draw_form('account_newsletter', smn_href_link(FILENAME_ACCOUNT_NEWSLETTERS, 'ID='.$store_id, 'NONSSL')) . smn_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
