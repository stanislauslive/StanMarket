...
*/
/*Added store id in the link FILENAME_CHECKOUT_CONFIRMATION by Cimi on June 12,2007*/
  echo smn_draw_form('checkout_payment', smn_href_link(FILENAME_CHECKOUT_CONFIRMATION, 'ID='.$_REQUEST['ID'], 'NONSSL'), 'post', 'onsubmit="return check_form();"'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
		  <!--Commented the L62 and added L63 by Cimi on June 12,2007 -->
            ...
            <td class="main"><b><?php echo HEADING_PRODUCTS; ?></b><?  echo ' <a href="' . smn_href_link(FILENAME_CHECKOUT_SELECT) . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td> 
				<!--Added store id in the link FILENAME_CHECKOUT_PAYMENT_ADDRESS by Cimi on June 12,2007 -->
                <td class="main" width="50%" valign="top"><?php echo TEXT_SELECTED_BILLING_DESTINATION; ?><br><br><?php echo '<a href="' . smn_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, 'ID='.$_REQUEST['ID'], 'NONSSL') . '">' . smn_image_button('button_change_address.gif', IMAGE_BUTTON_CHANGE_ADDRESS) . '</a>'; ?></td>
