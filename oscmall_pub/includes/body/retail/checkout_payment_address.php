...
?>
	...
	echo smn_draw_form('checkout_address', smn_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'NONSSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"').smn_draw_hidden_field('ID', $_REQUEST['ID']); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
?>
      ...
      <tr>
        <td><?php echo smn_draw_separator('pixel_trans', '100%', '10'); ?> </tr>
<?php
  }
            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td align="right" width="50%" valign="top"><table border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main" align="center" valign="top"><?php echo '<b>' . TITLE_PAYMENT_ADDRESS . '</b><br>' . smn_image(DIR_WS_IMAGES . 'arrow_south_east.gif'); ?></td>
                    <td><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
...
?>
                    ...
                    <td class="main" align="right"><?php echo smn_draw_radio_field('address', $addresses['address_book_id'], ($addresses['address_book_id'] == $billto)); ?></td>
                    <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                  </tr>
                  <tr>
                    <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                    <td colspan="3"><table border="0" cellspacing="0" cellpadding="2">
                      <tr>
                        <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                        <td class="main"><?php echo smn_address_format($format_id, $addresses, true, ' ', ', '); ?></td>
                        <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                      </tr>
                    </table></td>
                    <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td class="main" align="right"><?php echo smn_draw_hidden_field('action', 'submit') . smn_image_submit('button_continue.gif', IMAGE_BUTTON_CONTINUE); ?></td>
                <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
            </table></td>
          </tr>
...
?>
      ...
      <tr>
        <td><?php echo '<a href="' . smn_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'NONSSL') . '">' . smn_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
      </tr>
<?php
  }
?>
