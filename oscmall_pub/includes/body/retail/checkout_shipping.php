...
*/
  ?>
    ...
    <?php 
	/* Added ID as hidden field to keep track of the store id by Cimi on June 12,2007 */
	echo smn_draw_form('checkout_address', smn_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'NONSSL')) . smn_draw_hidden_field('action', 'process').smn_draw_hidden_field('ID', $_REQUEST['ID']); ?>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
				...
				<!--Added the store id in the link FILENAME_CHECKOUT_SHIPPING_ADDRESS by Cimi on June 12,2007 -->
                <td class="main" width="50%" valign="top"><?php echo TEXT_CHOOSE_SHIPPING_DESTINATION . '<br><br><a href="' . smn_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, 'ID='.$_REQUEST['ID'], 'NONSSL') . '">' . smn_image_button('button_change_address.gif', IMAGE_BUTTON_CHANGE_ADDRESS) . '</a>'; ?></td>
