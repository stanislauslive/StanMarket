...
?>
	...
	/*Added the store id as hidden field by Cimi on June 12,2007*/
	 echo smn_draw_form('checkout_address', smn_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'NONSSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"').smn_draw_hidden_field('ID', $_REQUEST['ID']); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
?>
                    ...
                    <td class="main" colspan="2"><b><?php echo smn_output_string_protected($addresses['firstname'] . ' ' . $addresses['lastname']); ?></b></td>
                    <td class="main" align="right"><?php echo smn_draw_radio_field('address', $addresses['address_book_id'], ($addresses['address_book_id'] == $sendto)); ?></td>
                    <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                  </tr>
                  <tr>
                    <td width="10"><?php echo smn_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
...
?>
      ...
      <tr>
        <td><?php echo '<a href="' . smn_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'NONSSL') . '">' . smn_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
      </tr>
<?php
  }
?>
