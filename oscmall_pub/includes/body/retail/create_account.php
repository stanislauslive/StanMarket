...
*/
 ?>
    ...
    <?php echo smn_draw_form('create_account', smn_href_link(FILENAME_CREATE_ACCOUNT, '', 'NONSSL'), 'post', 'onSubmit="return check_form(create_account);"') . smn_draw_hidden_field('action', 'process'); ?>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo smn_draw_input_field('telephone') . '&nbsp;' . (smn_not_null(ENTRY_TELEPHONE_NUMBER_TEXT) ? '<span class="inputRequirement">' . ENTRY_TELEPHONE_NUMBER_TEXT . '</span>': ''); ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo ENTRY_FAX_NUMBER; ?></td>
                <td class="main"><?php echo smn_draw_input_field('fax') . '&nbsp;' . (smn_not_null(ENTRY_FAX_NUMBER_TEXT) ? '<span class="inputRequirement">' . ENTRY_FAX_NUMBER_TEXT . '</span>': ''); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
