      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php if ($action == 'edit') {echo HEADING_EDIT_TITLE;}elseif($action == 'delete'){echo HEADING_DELETE_TITLE;} ?></td>
            <td class="pageHeading" align="right"><?php echo smn_draw_separator('pixel_trans.gif', 1, HEADING_IMAGE_HEIGHT); ?></td>
            <td class="pageHeading" align="right"><?php echo '<a href="' . smn_href_link(FILENAME_STORE_ORDER_TOOL,'ID='.$store_id) . '">' . smn_image_button('small_back.gif', IMAGE_BACK) . '</a>'; ?></td>
          </tr>
        </table></td>
      </tr>
<?php
