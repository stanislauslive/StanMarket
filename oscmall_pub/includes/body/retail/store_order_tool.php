            ...
            <tr class="infoBoxContents">
              <td><table border="0" width="100%" cellspacing="2" cellpadding="4">
                <tr>
                  ...
                  <td class="main" width="20%"><?php echo '<a href="' . smn_href_link(FILENAME_STORE_ORDER_EDIT, 'oID=' . $history['orders_id'].'&action=edit&ID='.$store_id, 'NONSSL') . '">' . smn_image_button('small_edit.gif', SMALL_IMAGE_BUTTON_EDIT) . '</a>'.'<br>'.'<a href="' . smn_href_link(FILENAME_STORE_ORDER_EDIT, 'oID=' . $history['orders_id'].'&action=delete&ID='.$store_id, 'NONSSL') . '">' . smn_image_button('small_delete.gif', SMALL_IMAGE_BUTTON_DELETE) . '</a>'; ?></td>
                </tr>
              </table></td>
            </tr>
          </table>
