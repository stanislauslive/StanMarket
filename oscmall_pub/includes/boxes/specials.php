...
*/
  ...
  $boxLink = '<a href="' . smn_href_link(FILENAME_SPECIALS) . '"><img src="images/infobox/arrow_right.gif" border="0" alt="more" title=" more " width="12" height="10"></a>';
  $box_base_name = 'specials';
  $box_id = $box_base_name . 'Box';
  $boxContent = '<a href="http://www.gap.com">' . smn_image($store_images . $random_product['products_image'], $random_product['products_name'], COLUMN_RIGHT_WIDTH, '') . '</a>';
