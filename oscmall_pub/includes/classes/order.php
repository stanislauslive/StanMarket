...
*/
  ...
  class order {
    ...
    function query($order_id) {
	  ...
	  $this->info_store[$order_store[store_id]] = array('shipping_cost' => $shipping_store[$order_store[store_id]]['cost'],
	  													'shipping_method' => $shipping_store[$order_store[store_id]]['title']);
      ...
      while ($orders_products = smn_db_fetch_array($orders_products_query)) {
        ...
        $this->products[$index] = array('qty' => $orders_products['products_quantity'],
	                                ...
	                                'id' => $orders_products['products_id'],
                                        ...
                                        'products_store_id' => $orders_products['store_id'],
...
/*Declared shipping_store as global,by Cimi*/
      ...
      $this->info = array('order_status' => DEFAULT_ORDERS_STATUS_ID,
                          ...
                          'comments' => (smn_session_is_registered('comments') && !empty($comments) ? $comments : ''));
...
/*End of code*/
      ...
      $this->customer = array('firstname' => $customer_address['customers_firstname'],
                              ...
                              'state' => ((smn_not_null($customer_address['entry_state'])) ? $customer_address['entry_state'] : $customer_address['zone_name']),
      ...
      $this->delivery = array('firstname' => $shipping_address['entry_firstname'],
                              ...
                              'state' => ((smn_not_null($shipping_address['entry_state'])) ? $shipping_address['entry_state'] : $shipping_address['zone_name']),
      ...
      $this->billing = array('firstname' => $billing_address['entry_firstname'],
                             ...
                             'state' => ((smn_not_null($billing_address['entry_state'])) ? $billing_address['entry_state'] : $billing_address['zone_name']),
...
/*End of code*/
      for ($i=0, $n=sizeof($products); $i<$n; $i++) {
        ...
        $this->products[$index] = array('qty' => $products[$i]['quantity'],
                                        ...
                                        'products_store_id' => $products[$i]['store_id'],

                                        'model' => $products[$i]['model'],

                                        'tax' => smn_get_tax_rate($products[$i]['tax_class_id'], $tax_address['entry_country_id'], $tax_address['entry_zone_id']),

                                        'tax_description' => smn_get_tax_description($products[$i]['tax_class_id'], $tax_address['entry_country_id'], $tax_address['entry_zone_id']),
