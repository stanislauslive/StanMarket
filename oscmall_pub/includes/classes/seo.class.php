 ...
 */	
	function SEO_URL_INSTALLER(){
     global $store_id, $store;
		$this->attributes = array();
		
		$x = 0;
		$this->default_config = array();
		$this->default_config['SEO_ENABLED'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Enable SEO URLs?', 'SEO_ENABLED', 'true', 'Enable the SEO URLs?  This is a global setting and will turn them off completely.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['SEO_ADD_CPATH_TO_PRODUCT_URLS'] = array('DEFAULT' => 'false',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Add cPath to product URLs?', 'SEO_ADD_CPATH_TO_PRODUCT_URLS', 'false', 'This setting will append the cPath to the end of product URLs (i.e. - some-product-p-1.html?cPath=xx).', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['SEO_ADD_CAT_PARENT'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Add category parent to begining of URLs?', 'SEO_ADD_CAT_PARENT', 'true', 'This setting will add the category parent name to the beginning of the category URLs (i.e. - parent-category-c-1.html).', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['SEO_URLS_FILTER_SHORT_WORDS'] = array('DEFAULT' => '3',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Filter Short Words', 'SEO_URLS_FILTER_SHORT_WORDS', '3', 'This setting will filter words less than or equal to the value from the URL.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, NULL)");
		$x++;
		$this->default_config['SEO_URLS_USE_W3C_VALID'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Output W3C valid URLs (parameter string)?', 'SEO_URLS_USE_W3C_VALID', 'true', 'This setting will output W3C valid URLs.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['USE_SEO_CACHE_GLOBAL'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Enable SEO cache to save queries?', 'USE_SEO_CACHE_GLOBAL', 'true', 'This is a global setting and will turn off caching completely.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['USE_SEO_CACHE_PRODUCTS'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Enable product cache?', 'USE_SEO_CACHE_PRODUCTS', 'true', 'This will turn off caching for the products.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['USE_SEO_CACHE_CATEGORIES'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Enable categories cache?', 'USE_SEO_CACHE_CATEGORIES', 'true', 'This will turn off caching for the categories.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['USE_SEO_CACHE_MANUFACTURERS'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Enable manufacturers cache?', 'USE_SEO_CACHE_MANUFACTURERS', 'true', 'This will turn off caching for the manufacturers.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['USE_SEO_CACHE_ARTICLES'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Enable articles cache?', 'USE_SEO_CACHE_ARTICLES', 'true', 'This will turn off caching for the articles.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['USE_SEO_CACHE_TOPICS'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Enable topics cache?', 'USE_SEO_CACHE_TOPICS', 'true', 'This will turn off caching for the article topics.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['USE_SEO_CACHE_INFO_PAGES'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Enable information cache?', 'USE_SEO_CACHE_INFO_PAGES', 'true', 'This will turn off caching for the information pages.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['USE_SEO_REDIRECT'] = array('DEFAULT' => 'true',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Enable automatic redirects?', 'USE_SEO_REDIRECT', 'true', 'This will activate the automatic redirect code and send 301 headers for old to new URLs.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['SEO_REWRITE_TYPE'] = array('DEFAULT' => 'Rewrite',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Choose URL Rewrite Type', 'SEO_REWRITE_TYPE', 'Rewrite', 'Choose which SEO URL format to use.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''Rewrite''),')");
		$x++;
		$this->default_config['SEO_CHAR_CONVERT_SET'] = array('DEFAULT' => '',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Enter special character conversions', 'SEO_CHAR_CONVERT_SET', '', 'This setting will convert characters.<br><br>The format <b>MUST</b> be in the form: <b>char=>conv,char2=>conv2</b>', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, NULL)");
		$x++;
		$this->default_config['SEO_REMOVE_ALL_SPEC_CHARS'] = array('DEFAULT' => 'false',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Remove all non-alphanumeric characters?', 'SEO_REMOVE_ALL_SPEC_CHARS', 'false', 'This will remove all non-letters and non-numbers.  This should be handy to remove all special characters with 1 setting.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'smn_cfg_select_option(array(''true'', ''false''),')");
		$x++;
		$this->default_config['SEO_URLS_CACHE_RESET'] = array('DEFAULT' => 'false',
		'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES ('" . $store_id . "', '', 'Reset SEO URLs Cache', 'SEO_URLS_CACHE_RESET', 'false', 'This will reset the cache data for SEO', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), 'smn_reset_cache_data_seo_urls', 'smn_cfg_select_option(array(''reset'', ''false''),')");
 ...
 */	
	function uninstall_settings(){
	 global $store_id, $store;
		$this->DB->Query("DELETE FROM `".TABLE_CONFIGURATION_GROUP."` WHERE `configuration_group_title` LIKE '%SEO%' and group_owner = 'store'");
		$this->DB->Query("DELETE FROM `".TABLE_CONFIGURATION."` WHERE `configuration_key` LIKE '%SEO%' and store_id = '" . $store_id . "'");
 ...
 */	
	function SEO_URL($languages_id){
		...
		$this->data = array(); 
		/*changed the array seo_pages to give seo urls for other pages also by Cimi on June 12,2007*/
		/*$seo_pages = array(FILENAME_DEFAULT, 
		                   FILENAME_STORE_LISTING, 
		...
		/* Added the 'products_id_review_write' => '-prw-', in the array to add SEO URL to product rewite page By Cimi on June 08,2007*/
 ...
 */	
	function parse_parameters($page, $params, &$separator){
		...
		$container = array();
		$this->storeID = '1';
		if (($idPos = strpos($params, 'ID=')) !== false){
		   $idBegin = substr($params, $idPos);
		   if (($ampPos = strpos($idBegin, '&')) !== false){
              $idGetVar = substr($idBegin, 0, $ampPos);
		   }else{
              $idGetVar = $idBegin;
		   }
		   $storeVar = explode('=', $idGetVar);
		   $this->storeID = $storeVar[1];
		}
		foreach ($p as $index => $valuepair){
			...
			switch ($p2[0]){ 
				case 'products_id':
					switch(true){
						...
						case ( $page == FILENAME_PRODUCT_REVIEWS_INFO ):							
							...
							break;
				/* Added the L829 to L831 to add SEO URL to product rewite page By Cimi on June 08,2007*/
				...
				case 'sPath':
					switch(true){
						case ($page == FILENAME_STORE_LISTING):
							$url = $this->make_url($page, $this->get_store_name($p2[1]), $p2[0], $p2[1], '.html', $separator);
							break;
						default:
							$container[$p2[0]] = $p2[1];
							break;
				...
				case 'ID':
					switch(true){
						case ($page == FILENAME_DEFAULT):
							$container[$p2[0]] = $p2[1];
							break;
				/* Added the L933 to L934 to add SEO URL to contact us page By Cimi on June 08,2007*/
						case ($page == FILENAME_CONTACT_US):
							$container[$p2[0]] = $p2[1];
							break;
				/* Added the L938 to L955 to add SEO URL to checkout select By Cimi on June 12,2007*/
						case ($page == FILENAME_CHECKOUT_SELECT):
							$container[$p2[0]] = $p2[1];
							break;
						case ($page == FILENAME_CHECKOUT_SHIPPING):
							$container[$p2[0]] = $p2[1];
							break;
						case ($page == FILENAME_CHECKOUT_SHIPPING_ADDRESS):
							$container[$p2[0]] = $p2[1];
							break;
						case ($page == FILENAME_CHECKOUT_PAYMENT):
							$container[$p2[0]] = $p2[1];
							break;
						case ($page == FILENAME_CHECKOUT_PAYMENT_ADDRESS):
							$container[$p2[0]] = $p2[1];
							break;
						case ($page == FILENAME_CHECKOUT_CONFIRMATION):
							$container[$p2[0]] = $p2[1];
							break;
						default: 
							break;
 ...
 */	
	function make_url($page, $string, $anchor_type, $id, $extension = '.html', &$separator){
		...
		switch ( $this->attributes['SEO_REWRITE_TYPE'] ){
			case 'Rewrite':
				return $string . $this->reg_anchors[$anchor_type] . $id . (isset($this->storeID) ? '-sid-' . $this->storeID : '') . $extension;
				break;
			default:
				break;
		} # end switch
 ...
 */	
	function get_product_name($pID){
		switch(true){
		  ...
		  /* Changed the query to add product name in the seo url by Cimi on June 08,2007 */
			...
			default:
				...
				switch(true){
					case ($this->attributes['SEO_ADD_CAT_PARENT'] == 'true'):
					 ...
					 /* Changed the query to add category name in the seo url by Cimi on June 08,2007 */
...
/**
 * Function to get the store name. Use evaluated cache, per page cache, or database query in that order of precedent 
 * @author Stephen Walker 
 * @version 1.1
 * @param integer $sID NOTE: passed by reference
 * @return string Stripped anchor text
 */	
	function get_store_name(&$sID){
		$full_sPath = $this->get_full_sPath($sID, $single_sID); // full cPath needed for uniformity
		switch(true){
			case ($this->attributes['USE_SEO_CACHE_GLOBAL'] == 'true' && defined('STORE_NAME_' . $full_sPath)):
				$this->performance['CACHE_QUERY_SAVINGS']++;
				$return = constant('STORE_NAME_' . $full_sPath);
				$this->cache['STORES'][$full_sPath] = $return;
				break;
			case ($this->attributes['USE_SEO_CACHE_GLOBAL'] == 'true' && isset($this->cache['STORES'][$full_sPath])):
				$this->performance['CACHE_QUERY_SAVINGS']++;
				$return = $this->cache['STORES'][$full_sPath];
				break;
			default:
				$this->performance['NUMBER_QUERIES']++;
				switch(true){
					case ($this->attributes['SEO_ADD_STORE_PARENT'] == 'true'):
						 ...
						 $sql = "SELECT c.store_categories_id, c.parent_id, cd.store_categories_name as sName, cd2.store_categories_name as sName2  
								  FROM ".TABLE_STORE_CATEGORIES." c, 
								  ".TABLE_STORE_CATEGORIES_DESCRIPTION." cd 
								  LEFT JOIN ".TABLE_STORE_CATEGORIES_DESCRIPTION." cd2 
								  ON c.parent_id=cd2.categories_id AND cd2.language_id='".(int)$this->languages_id."' 
								  WHERE c.store_categories_id='".(int)$single_sID."' 
								  AND cd.store_categories_id='".(int)$single_sID."' 
								  AND cd.language_id='".(int)$this->languages_id."' 
								  LIMIT 1";
						  $result = $this->DB->FetchArray( $this->DB->Query( $sql ) );
					      $sName = $this->not_null($result['sName2']) ? $result['sName2'] . ' ' . $result['sName'] : $result['sName'];
						break;
					default:

						  $sql = "SELECT store_categories_name as sName 
								  FROM ".TABLE_STORE_CATEGORIES_DESCRIPTION." 
								  WHERE store_categories_id='".(int)$single_sID."' 
								  AND language_id='".(int)$this->languages_id."' 
								  LIMIT 1";
						  $result = $this->DB->FetchArray( $this->DB->Query( $sql ) );
						  $sName = $result['sName'];						  
				...
				$sName = $this->strip($sName);
				$this->cache['STORES'][$full_sPath] = $sName;
				$this->performance['QUERIES']['STORES'][] = $sql;
				$return = $sName;
				break;								
		} # end switch		
		$sID = $full_sPath;
...
/**
 * Function to retrieve full sPath from store ID 
 * @version 1.1
 * @param mixed $sID Could contain sPath or single store_id
 * @param integer $original Single store_id passed back by reference
 * @return string Full sPath string
 */	
	function get_full_sPath($sID, &$original){
		if ( is_numeric(strpos($sID, '_')) ){
			$temp = @explode('_', $sID);
			$original = $temp[sizeof($temp)-1];
			return $sID;
		} else {
			$s = array();
			$this->GetParentStores($s, $sID);
			$s = array_reverse($s);
			$s[] = $sID;
			$original = $sID;
			$sID = sizeof($s) > 1 ? implode('_', $s) : $sID;
			return $sID;
		}
	} # end function
...
/**
 * Recursion function to retrieve parent stores from store ID 
 * @version 1.0
 * @param mixed $stores Passed by reference
 * @param integer $store_id
 */	
	function GetParentStores(&$stores, $store_id) {
		$sql = "SELECT parent_id 
		        FROM " . TABLE_STORE_CATEGORIES . " 
				WHERE store_categories_id='" . (int)$store_id . "'";
		$parent_stores = $this->DB->Query($sql);
		while ($parent_stores = $this->DB->FetchArray($parent_stores_query)) {
			if ($parent_stores['parent_id'] == 0) return true;
			$stores[sizeof($stores)] = $parent_stores['parent_id'];
			if ($parent_stores['parent_id'] != $store_id) {
				$this->GetParentStores($stores, $parent_stores['parent_id']);
			}
		}
	} # end function
 ...
 */	
	function do_redirect(){
		...
		switch(true){
		    case ($this->uri_parsed['path'] .'?' . $params == $this->real_uri):
			    break;
