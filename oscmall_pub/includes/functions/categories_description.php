...
*/
   ...
   function smn_get_category_heading_title($category_id, $language_id) {
    ...
    $category_query = smn_db_query("select categories_heading_title from " . TABLE_CATEGORIES_DESCRIPTION . " where categories_id = '" . $category_id . "' and language_id = '" . $language_id . "' and store_id = '" . $store_id . "'");
