...
*/
  ...
  define('FILENAME_ACCOUNT_EDIT_DESCRIPTION', 'account_edit_description.php');
  define('FILENAME_ACCOUNT_PRODUCTS', 'account_products.php');
  define('FILENAME_ACCOUNT', 'account.php');
  define('FILENAME_ALLPRODS', 'allprods.php');
  define('FILENAME_ACCOUNT_EDIT', 'account_edit.php');
  define('FILENAME_ACCOUNT_HISTORY', 'account_history.php');
  /*Added by Cimi*/
  define('FILENAME_STORE_ORDER_DETAILS', 'store_order_details.php');
  define('FILENAME_STORE_ORDER_TOOL', 'store_order_tool.php');
  define('FILENAME_STORE_ORDER_EDIT', 'store_order_edit.php');
  define('FILENAME_ORDERS_INVOICE', 'invoice.php');
  define('FILENAME_ORDERS_PACKINGSLIP', 'packingslip.php');
  define('FILENAME_STORE_PRODUCT_CATEGORIES', 'store_product_categories.php');
  define('FILENAME_STORE_TEXT_EDITOR','store_text_editor.php');
  define('FILENAME_COUNTRIES','countries.php');
  define('FILENAME_ZONES','zones.php');
  define('FILENAME_TAX_ZONES','tax_zones.php');
  ...
  define('FILENAME_CHECKOUT_SELECT', 'checkout_select.php');
  ...
  define('FILENAME_THANK_YOU', 'thank_you.php');
  define('FILENAME_INDEX', 'index.php');
  define('FILENAME_INFORMATION', 'information.php');
  define('FILENAME_CREATE_STORE', 'create_store.php');
  define('FILENAME_CREATE_STORE_ACCOUNT', 'create_store_account.php');
  define('FILENAME_CREATE_STORE_ACCOUNT_SUCCESS', 'create_store_account_success.php');
  define('FILENAME_STORE_LISTING','store_listing.php');
  ...
  define('FILENAME_STORE_TAXES', 'store_taxes.php');
  define('FILENAME_STORE_MODULES', 'store_modules.php');
