...
*/
function smn_set_database_tables($store_prefix)
{ 
// define the database table names used in the project
  ...
  define('TABLE_PRODUCTS_ATTRIBUTES', $store_prefix . '_' . 'products_attributes');
  define('TABLE_PRODUCTS_ATTRIBUTES_DOWNLOAD', $store_prefix . '_' . 'products_attributes_download');
  define('TABLE_PRODUCTS_DESCRIPTION', 'products_description');
  define('TABLE_PRODUCTS_NOTIFICATIONS', $store_prefix . '_' . 'products_notifications');
  define('TABLE_PRODUCTS_OPTIONS', $store_prefix . '_' . 'products_options');
  define('TABLE_PRODUCTS_OPTIONS_VALUES', $store_prefix . '_' . 'products_options_values');
  define('TABLE_PRODUCTS_OPTIONS_VALUES_TO_PRODUCTS_OPTIONS', $store_prefix . '_' . 'products_options_values_to_products_options');
  ...
  define('TABLE_PRODUCTS_XSELL', $store_prefix . '_' .'products_xsell'); 
