...
// join the query before the comment appeared, with the rest of the dump
      ...
      osc_db_query("drop table if exists admin, admin_files, admin_groups, articles, template, web_site_content, dynamic_page_index, financial_data, store_reviews, store_costs, store_owner_data, store_to_categories, store_description, store_categories, store_categories_description, ccc, saved_orders, saved_orders_products, saved_orders_products_attributes, address_book, address_format, banners, banners_history, categories, categories_description, configuration, configuration_group, counter, counter_history, countries, currencies, customers, customers_basket, customers_basket_attributes, customers_info, languages, manufacturers, manufacturers_info, orders, orders_products, orders_status, orders_status_history, orders_products_attributes, orders_products_download, products, products_attributes, products_attributes_download, prodcts_description, products_options, products_options_values, products_options_values_to_products_options, products_to_categories, reviews, reviews_description, sessions, specials, tax_class, tax_rates, geo_zones, whos_online, zones, zones_to_geo_zones");
