      ...
      case 'update_product':
        if (isset($_POST['edit_x']) || isset($_POST['edit_y']) && ($allow_insert == 'true')) {
          ...
          if (! checkVoucherPermissions($store_id, $_POST['products_model'])) {
            ...
            $sql_data_array = array('store_id' => (int)$store_id,
                                    'products_quantity' => (int)smn_db_prepare_input($_POST['products_quantity']),
                                    ...
                                    'products_weight' => (float)smn_db_prepare_input($_POST['products_weight']),
                                    ...
                                    'manufacturers_id' => (int)smn_db_prepare_input((empty($_POST['manufacturers_id']) ? 'null' : $_POST['manufacturers_id'])));
