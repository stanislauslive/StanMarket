...
function smn_set_database_tables(){
...
// define the database table names used in the project
  ...
  define('TABLE_SAVED_ORDERS', 'saved_orders');
  define('TABLE_SAVED_ORDERS_PRODUCTS', 'saved_orders_products');
  define('TABLE_SAVED_ORDERS_PRODUCTS_ATTRIBUTES', 'saved_orders_products_attributes');
  
  define('TABLE_AFFILIATE', 'affiliate_affiliate');
  define('TABLE_AFFILIATE_NEWS', 'affiliate_news');
/*Defined the affiliate_news_contents table,by Cimi*/
