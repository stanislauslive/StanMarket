...
//stats reporter
define('BOX_REPORTS_SALES_REPORT3', 'oscMall Sales Reporter');
...
define('BOX_GV_ADMIN_REPORT', 'Vendors Report');
...
define('HEADER_TITLE_HELP', 'Help Files');
...
define('BOX_HEADING_AFFILIATE', 'Affiliate Agents');
...
define('BOX_AFFILIATE_NEWS', 'Affiliate Agent News');
define('BOX_AFFILIATE_NEWSLETTER_MANAGER', 'Affiliate Agent Newsletter');

define('BOX_TITLE_AFFILIATES', 'Affiliate Agents');
define('BOX_ENTRY_AFFILIATES', 'Affiliate Agents:');
...
define('BOX_CUSTOMERS_ORDERS_TRACKING', 'Orders Tracking Exporter');
define('BOX_CUSTOMERS_ORDERS_UPDATER', 'Qucik Orders Updater');
define('BOX_CUSTOMERS_ORDERS', 'Orders');

define('BOX_TEMPLATE','Template Manager');
define('BOX_MANAGEMENT', 'Store Manager');
define('BOX_TEXT_EDITOR','Web Site Text Editor');
define('BOX_COLUMN_CONTROLLER','Column Controller');
define('BOX_HEADING_LAYOUT_CUSTOMIZATION','Customization');
...
define('ENTRY_STORE_NAME_ERROR','You need to add in a new and Unique Name for the store.');
