...
// define the filenames used in the project
  ...
  define('FILENAME_TEXT_EDITOR', 'text_editor.php');
  define('FILENAME_ORDERS_UPDATER', 'orders_updater.php');  
  ...
  define('FILENAME_MANAGEMENT', 'management.php');
  define('FILENAME_ORDERS_TRACKING', 'orders_tracking.php');
