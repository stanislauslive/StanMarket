            ...
            <td><table width="100%" border="0" cellpadding="4" cellspacing="2" class="dataTableContent">
              <center>
                ...
                <tr>
                  ...
                  <td width="15%" class="dataTableContent"><?php echo smn_round(AFFILIATE_PERCENT, 2) . ' %'; ?></td>
                ...
                <tr>
                  <td align="right" class="dataTableContent" colspan="4"><?php echo '<a href="' . smn_href_link(FILENAME_AFFILIATE_BANNERS, '') . '">' . smn_image_button('button_affiliate_banners.gif', IMAGE_BANNERS) . '</a> <a href="' . smn_href_link(FILENAME_AFFILIATE_CLICKS, '') . '">' . smn_image_button('button_affiliate_clickthroughs.gif', IMAGE_CLICKTHROUGHS) . '</a> <a href="' . smn_href_link(FILENAME_AFFILIATE_SALES, '') . '">' . smn_image_button('button_affiliate_sales.gif', IMAGE_SALES) . '</a>'; ?></td>
                </tr>
              </center>
            </table></td>
          </tr>
