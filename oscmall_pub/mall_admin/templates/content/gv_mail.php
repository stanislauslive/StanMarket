...
?>
          <tr><?php echo smn_draw_form('mail', FILENAME_GV_MAIL, 'action=send_email_to_user'); ?>
...
?>
                <table border="0" width="100%" cellpadding="0" cellspacing="2">
                  <tr>
                    ...
                    <td align="right"><?php echo '<a href="' . smn_href_link(FILENAME_GV_MAIL) . '">' . smn_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a> ' . smn_image_submit('button_send_mail.gif', IMAGE_SEND_EMAIL); ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
...
?>
          <tr><?php echo smn_draw_form('mail', FILENAME_GV_MAIL, 'action=preview'); ?>
...
?>
              ...
              <tr>
               ...
               <tr>
                ...
                <td><?php echo smn_draw_input_field('email_to'); ?><?php echo '&nbsp;&nbsp;' . TEXT_SINGLE_EMAIL; ?></td>
              </tr>
              <tr>
                <td colspan="2"><?php echo smn_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
              </tr>
             <tr>
              ...
              <tr>
                ...
                <td><?php echo smn_draw_input_field('amount'); ?></td>
              </tr>
              <tr>
                <td colspan="2"><?php echo smn_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
              </tr>
